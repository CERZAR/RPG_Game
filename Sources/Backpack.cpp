...
void Backpack::update(Player *player) {
    ...
    if (player->haveSecondWeapon == true) {
        ...
        backpackTextArray[14]->setString("ATACK SPEED: " + std::to_string(
                player->currentWeapon->atackSpeed));
        backpackTextArray[15]->setPosition(x + 820, y + 390);
        backpackTextArray[15]->setString("BULLET SPEED: " + std::to_string(
                (int) player->currentWeapon->speed));
        backpackTextArray[16]->setPosition(x + 820, y + 415);
        backpackTextArray[16]->setString("FLIGHT TIME: " + std::to_string(
                (int) player->currentWeapon->lifetime / 1000));
        ...
        if (player->currentWeapon->level == 5) {
            ...
            backpackTextArray[17]->setString("UPGRATE COST: " + std::to_string(
                    player->currentWeapon->upgateCost));
    }
    ...
    backpackTextArray[20]->setString("ATACK SPEED: " + std::to_string(
            player->currentWeapon->atackSpeed));
    backpackTextArray[21]->setPosition(x + 820, y + 140);
    backpackTextArray[21]->setString("BULLET SPEED: " + std::to_string(
            (int) player->currentWeapon->speed));
    backpackTextArray[22]->setPosition(x + 820, y + 165);
    backpackTextArray[22]->setString("FLIGHT TIME: " + std::to_string(
            (int) player->currentWeapon->lifetime / 1000));
    ...
    if (player->currentWeapon->level == 5) {
        ...
        backpackTextArray[23]->setString("UPGRATE COST: " + std::to_string(
                player->currentWeapon->upgateCost));
}
