...
ResourcesContainer::ResourcesContainer()
{
	...
	for (int i = 1; i <= 10; i++)
	{
		...
		pTexture->loadFromFile("../Resources/items/coin/" + std::to_string(i) + ".png");
	...
	for (int i = 1; i <= 8; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/health/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 10; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/energy/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
    ...
    for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/default_weapon/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
    ...
    for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon1/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon2/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon3/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon4/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/default_weapon/icon" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon1/icon" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon2/icon" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon3/icon" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 5; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon4/icon" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 6; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon1/bullet1/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 6; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon2/bullet2/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
	...
	for (int i = 1; i <= 6; i++)
	{
		auto* pTexture = new sf::Texture;
		auto* sprite = new sf::Sprite;
		pTexture->loadFromFile("../Resources/items/weapons/weapon3/bullet3/" + std::to_string(i) + ".png");
		sprite->setTexture(*pTexture);
