...
void Player::update()
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W) && sf::Keyboard::isKeyPressed(sf::Keyboard::D))
	{
		...
		this->sprite.setTextureRect(sf::IntRect(this->counterWalking * 48, 48 * 3, 48, 48));
		direction = -1;
	}
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::W) && sf::Keyboard::isKeyPressed(sf::Keyboard::A))
	{
		this->rect.move(-1 * this->movementSpeed / 2, -1 * this->movementSpeed / 2);
		this->sprite.setTextureRect(sf::IntRect(this->counterWalking * 48, 48 * 3, 48, 48));
		direction = -2;
	}
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::S) && sf::Keyboard::isKeyPressed(sf::Keyboard::D))
	{
		...
		this->sprite.setTextureRect(sf::IntRect(this->counterWalking * 48, 48 * 0, 48, 48));
		direction = -3;
	}
	...
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right) || sf::Keyboard::isKeyPressed(sf::Keyboard::D))
	{
		...
		this->sprite.setTextureRect(sf::IntRect(this->counterWalking * 48, 48 * 2, 48, 48));
		direction = RIGHT;
	}
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left) || sf::Keyboard::isKeyPressed(sf::Keyboard::A))
	{
		this->rect.move(-1 * this->movementSpeed, 0);
		this->sprite.setTextureRect(sf::IntRect(this->counterWalking * 48, 48 * 1, 48, 48));
		direction = LEFT;
	}
