...
Bullet3::Bullet3(int damage, float speed, int direction, float lifetime,
                 ResourcesContainer *res) : Bullet::Bullet(damage, speed,
                                                           direction, lifetime,
                                                           res) {
...
void Bullet3::update() {
    ...
    if (this->direction == UP) {
        ...
        sprite = *resContainter->bullet3[counterAnimation];
        ...
        sprite.setPosition(rect.getPosition().x - 22,
                           rect.getPosition().y + 30);
    } else if (this->direction == RIGHT) {
        this->rect.move(this->movementSpeed, 0);
        sprite = *resContainter->bullet3[counterAnimation];
        sprite.setRotation(180);
        sprite.setPosition(rect.getPosition().x + 30,
                           rect.getPosition().y + 46);
