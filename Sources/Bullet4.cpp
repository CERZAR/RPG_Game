...
Bullet4::Bullet4(int damage, float speed, int direction, float lifetime, ResourcesContainer* res) : Bullet::Bullet(damage, speed, direction, lifetime, res)
{
...
void Bullet4::update()
{
	...
	if (this->direction == UP)
	{
		...
		this->sprite.setTextureRect(sf::IntRect(this->counterAnimation * 16, 0, 16, 19));
