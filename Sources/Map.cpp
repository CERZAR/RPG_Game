...
void Map::createMap() {
    for (auto i = 0; i < int_vector.size(); i++) {
        for (auto j = 0; j < int_vector.size(); j++) {
            ...
            switch (int_vector[j][i]) {
                case 0: {
                    if (randomBox < 7)
                        vector.push_back(new Box(&sprite,
                                                 static_cast<float>(startX + i *
                                                                             tileSize),
                                                 static_cast<float>(startY + j *
                                                                             tileSize)));
                    groundVector.push_back(new Ground1(&sprite,
                                                       static_cast<float>(
                                                               startX +
                                                               i * tileSize),
                                                       static_cast<float>(
                ...
                case 1: {
                    if (randomBox < 18)
                        vector.push_back(new Box(&sprite,
                                                 ...
                                                 static_cast<float>(startY + j *
                                                                             tileSize)));
                    groundVector.push_back(new Ground2(&sprite,
                                                       static_cast<float>(
                                                               startX +
                                                               i * tileSize),
                                                       static_cast<float>(
                ...
                case 2: {
                    if (randomBox < 4)
                        vector.push_back(new Box(&sprite,
                                                 ...
                                                 static_cast<float>(startY + j *
                                                                             tileSize)));
                    groundVector.push_back(new Ground3(&sprite,
                                                       static_cast<float>(
                                                               startX +
                                                               i * tileSize),
                                                       static_cast<float>(
                ...
                case 4: {
                    vector.push_back(new SteelWall(&sprite,
                                                   static_cast<float>(startX +
                                                                      i *
                                                                      tileSize),
                                                   static_cast<float>(startY +
                ...
                case 5: {
                    vector.push_back(new DiamondWall(&sprite,
                                                     static_cast<float>(startX +
                                                                        i *
                                                                        tileSize),
                                                     static_cast<float>(startY +
                ...
                case 6: {
                    vector.push_back(new GroundWall(&sprite,
                                                    static_cast<float>(startX +
                                                                       i *
                                                                       tileSize),
                                                    static_cast<float>(startY +
    ...
    startX += tileSize;
    startY += tileSize;
    endX = static_cast<int>(vector[(int) vector.size() -
                                   1]->rect.getPosition().x) - tileSize;
