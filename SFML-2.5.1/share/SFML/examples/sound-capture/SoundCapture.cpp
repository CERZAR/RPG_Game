...
int main() {
  ...
  std::cout << "Please choose the sample rate for sound capture (44100 is CD "
               "quality): ";
  std::cin >> sampleRate;
  ...
  // Here we'll use an integrated custom recorder, which saves the captured data
  // into a SoundBuffer
  sf::SoundBufferRecorder recorder;

  // Audio capture is done in a separate thread, so we can block the main thread
