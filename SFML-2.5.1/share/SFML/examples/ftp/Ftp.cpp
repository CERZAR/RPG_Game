...
int main() {
  ...
  do {
    ...
    case 8: {
      ...
      std::cout << "Filename of the file to download (relative to current "
                   "directory): ";
      std::cin >> filename;
    ...
    case 9: {
      ...
      std::string filename, directory;
      std::cout << "Path of the file to upload (absolute or relative to "
                   "working directory): ";
      std::cin >> filename;
      std::cout << "Directory to upload the file to (relative to current "
                   "directory): ";
      std::cin >> directory;
