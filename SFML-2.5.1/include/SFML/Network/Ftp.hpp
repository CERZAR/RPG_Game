...
public:
  ...
  public:
    ...
    enum Status {
      ...
      SystemType = 215, ///< NAME system type, where NAME is an official system
      ...
      InvalidResponse =
          1000, ///< Not part of the FTP standard, generated by SFML when a
                ///< received response cannot be parsed
      ConnectionFailed =
          1001, ///< Not part of the FTP standard, generated by SFML when the
                ///< low-level socket connection with the server fails
      ConnectionClosed =
          1002, ///< Not part of the FTP standard, generated by SFML when the
                ///< low-level socket connection is unexpectedly closed
      InvalidFile = 1003 ///< Not part of the FTP standard, generated by SFML
                         ///< when a local file cannot be read or written
    };
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit Response(Status code = InvalidResponse,
  ...
  private:
    ...
    std::vector<std::string>
        m_listing; ///< Directory/file names extracted from the data
  };
  ...
  ///
  ////////////////////////////////////////////////////////////
  Response connect(const IpAddress &server, unsigned short port = 21,
  ...
  /// \param localPath  The directory in which to put the file on the local
  /// computer \param mode       Transfer mode
  ///
  /// \return Server response to the request
  ///
  /// \see upload
  ...
  /// \param append     Pass true to append to or false to overwrite the remote
...
private:
  ...
  // Member data
  ////////////////////////////////////////////////////////////
  TcpSocket m_commandSocket; ///< Socket holding the control connection with the
                             ///< server
  std::string
      m_receiveBuffer; ///< Received command data that is yet to be processed
};
