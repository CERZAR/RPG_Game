...
public:
  ...
  ///
  /// \param function Functor or free function to use as the entry point of the
  /// thread
  ///
  ////////////////////////////////////////////////////////////
  ...
  ///
  /// \param function Functor or free function to use as the entry point of the
  /// thread \param argument argument to forward to the function
  ///
  ////////////////////////////////////////////////////////////
...
/// compatibility with boost/std::%bind) \li functors with one argument of any
/// type \li member functions from any class with no argument
///
